...
instruction_label = ttk.Label(app, text="INSERT THE BELOW FIELDS INTO THE LOOKUP TYPE", foreground="black", font=font.Font(size=11), background="#CCCCCC")
...
insert_button = tk.Button(button_frame, text="INSERT", command=insert_lookup_type,
